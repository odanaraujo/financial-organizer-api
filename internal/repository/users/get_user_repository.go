...
func (repo *userRepository) GetUser(ctx context.Context, ID string) (entity.CreateUser, *excp.Exception) {

	logger.Info("init GetUser repository", zap.String("Journey", "GetUser"))
